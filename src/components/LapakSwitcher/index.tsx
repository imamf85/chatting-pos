...
export default function LapakSwitcher() {
  ...
  return (
    <select
      ...
      className="px-3 py-1.5 bg-orange-50 border border-orange-200 rounded-xl text-sm font-medium
                 text-orange-700 focus:outline-none focus:ring-2 focus:ring-orange-500
